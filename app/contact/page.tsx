...
export default function Contact() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center px-4 pt-10 font-sans sm:pt-12 md:pt-16">
      ...
      <div className="flex w-full max-w-md flex-col gap-4 sm:gap-6">
        <Link
          href="https://github.com/cellinacywinska"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-4 rounded-2xl border border-slate-200/80 bg-gradient-to-br from-slate-50 to-white p-5 shadow-md transition-all duration-200 hover:shadow-xl hover:border-pink-200 sm:p-6"
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-sm text-slate-500">View my projects and code</p>
          </div>
          <span className="text-slate-400" aria-hidden>→</span>
        </Link>

        <Link
          href="https://www.linkedin.com/in/celina-cywinska-1178591b4/"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-4 rounded-2xl border border-slate-200/80 bg-gradient-to-br from-slate-50 to-white p-5 shadow-md transition-all duration-200 hover:shadow-xl hover:border-pink-200 sm:p-6"
        >
        ...
        <Link
          href="mailto:celinacywinska@gmail.com"
          className="flex items-center gap-4 rounded-2xl border border-slate-200/80 bg-gradient-to-br from-slate-50 to-white p-5 shadow-md transition-all duration-200 hover:shadow-xl hover:border-pink-200 sm:p-6"
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-sm text-slate-500">celinacywinska@gmail.com</p>
          </div>
          <span className="text-slate-400" aria-hidden>→</span>
        </Link>
      </div>
